    ...
    getTickers: (markets) => {
        ...
        markets.forEach(name => {
            ...
            tickers[marketId] = {
                ...
                "low": `${(0.001 * Math.abs(change.toFixed(2))).toFixed(2)}`,
                "high": `${(0.145 * Math.abs(change.toFixed(2))).toFixed(2)}`,
                "last": `${(0.134 * Math.abs(change.toFixed(2))).toFixed(4)}`,
                "open": (0.134 * Math.abs(change.toFixed(2))).toFixed(2),
                "volume": `${(2000 * Math.abs(change.toFixed(2) * 10)).toFixed(2)}`,
                "sell": `${(1200 * Math.abs(change.toFixed(2))).toFixed(2)}`,
                "buy": `${(1300 * Math.abs(change.toFixed(2))).toFixed(2)}`,
                "avg_price": "0.0",
